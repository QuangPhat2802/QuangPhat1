...
public class VoucherController {
	...
	public String initPage(VoucherEntity voucherEntity, Model model) {
		...
		List<OrdersEntity> listOrders = ordersService.getListOrders();
...
//		List<VoucherEntity> getListVoucherByPhone = voucherService.findVoucherCodeByPhone(phone, minPrice);
		initPage(voucherEntity, model);
//		model.addAttribute("listByPhone", getListVoucherByPhone);
		return "admin";
	...
	public String initAddPhone(@RequestParam(name = "voucherCode") String voucherCode, Model model) {
		List<CustomerEntity> listCustomer = khachHangService.getAll();
